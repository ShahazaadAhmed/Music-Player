...
def prs():
    ...
    for i in range(0,math.ceil(sl)):
        time.sleep(0.3)
        pro.set(pygame.mixer.music.get_pos()/1000000)
...
vol.pack(pady=10)
br=ck.CTkButton(root,text='X',width=10,height=10,fg_color='#242424',hover_color='#333333',command=stps)
br.place(relx=0.85,rely=0.91)

root.protocol("WM_DELETE_WINDOW", lambda: [pygame.mixer.music.stop(), pygame.mixer.quit(), root.destroy()])
